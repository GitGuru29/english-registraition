...
export default function App() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-xl px-4 py-5 sm:px-6 sm:py-10">
      <div className="overflow-hidden rounded-[1.75rem] border border-slate-200/80 bg-white shadow-[0_18px_45px_rgb(20_33_61_/_0.08)]">
        <header className="border-b border-slate-100 px-6 pb-7 pt-8 text-center sm:px-10 sm:pt-10">
          ...
          <div className="mt-7 border-y border-[#dce8e1] py-4">
            <p className="sinhala text-[1.65rem] font-extrabold leading-tight text-[#126950] sm:text-3xl">
        ...
        <section aria-labelledby="form-title" className="px-6 py-7 sm:px-10 sm:py-8">
          <div className="sinhala text-center">
            <h2 id="form-title" className="text-2xl font-bold tracking-[-0.02em]">{copy.formTitle}</h2>
            <p className="mx-auto mt-2 max-w-sm text-sm leading-6 text-slate-600">{copy.formHelp}</p>
          </div>
