...
export default function SuccessState() {
  return (
    <section aria-live="polite" className="sinhala mt-8 rounded-2xl border border-leaf/20 bg-[#effaf5] p-6 text-center">
      ...
      <p className="mt-1 text-sm text-slate-600">{copy.successHelp}</p>
    </section>
  )
}
